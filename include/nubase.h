...
public:
 ...
 nubase(const gauge<n> g_in, const self<m> La_in, const yukawa Yu_in, const yukawa Yd_in, const yukawa Ye_in, const yukawa Yn_in, const yukawa Ka_in, const yukawa Mn_in, const unsigned int nloops_in) : g(g_in), La(La_in), Yu(Yu_in), Yd(Yd_in), Ye(Ye_in), Yn(Yn_in), Ka(Ka_in), Mn(Mn_in), nloops(nloops_in) {};
 nubase(const gauge<n> g_in, const self<m> La_in, const yukawa Yu_in, const yukawa Yd_in, const yukawa Ye_in, const yukawa Yn_in, const yukawa Ka_in, const yukawa Mn_in) : g(g_in), La(La_in), Yu(Yu_in), Yd(Yd_in), Ye(Ye_in), Yn(Yn_in), Ka(Ka_in), Mn(Mn_in), nloops(2) {};
  // constructor that sets all selfcouplings to zero
 nubase(const gauge<n> g_in, const yukawa Yu_in, const yukawa Yd_in, const yukawa Ye_in, const yukawa Yn_in, const yukawa Ka_in, const yukawa Mn_in, const unsigned int nloops_in) : g(g_in), La(), Yu(Yu_in), Yd(Yd_in), Ye(Ye_in), Yn(Yn_in), Ka(Ka_in), Mn(Mn_in), nloops(nloops_in)  {};
 nubase(const gauge<n> g_in, const yukawa Yu_in, const yukawa Yd_in, const yukawa Ye_in, const yukawa Yn_in, const yukawa Ka_in, const yukawa Mn_in) : g(g_in), La(), Yu(Yu_in), Yd(Yd_in), Ye(Ye_in), Yn(Yn_in), Ka(Ka_in), Mn(Mn_in), nloops(2)  {};
...
template<int n, int m> nubase<n,m> operator/( const nubase<n,m> &lhs , const nubase<n,m> &rhs ){
  return nubase<n,m>( lhs.g.cwiseQuotient(rhs.g),		 lhs.La.cwiseQuotient(rhs.La),
		 lhs.Yu.cwiseQuotient(rhs.Yu),		 lhs.Yd.cwiseQuotient(rhs.Yd),
		 lhs.Ye.cwiseQuotient(rhs.Ye),		 lhs.Yn.cwiseQuotient(rhs.Yn),
		 lhs.Ka.cwiseQuotient(rhs.Ka),		 lhs.Mn.cwiseQuotient(rhs.Mn), lhs.getNloops()
		 );
}
