...
as \texttt{SARAH} \cite{Staub:2013tta}, PyR@TE \cite{Lyonnet:2016xiz,Sartore:2020gou} and ARGES \cite{Litim:2020jvl}\footnote{PyR@TE and ARGES also implement the results for three-loop gauge coupling beta functions \cite{Poole:2019kcm}}.
