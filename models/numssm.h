...
class numssm : public nubase<3,0> {
 ...
 public:
 numssm() : nubase<3,0>() {};
 numssm(const gauge<3> g_in, const yukawa Yu_in, const yukawa Yd_in, const yukawa Ye_in, const yukawa Yn_in, const yukawa Ka_in, const yukawa Mn_in, const int nloops_in, const bool weylordering_in) : nubase<3,0>(g_in, Yu_in, Yd_in, Ye_in, Yn_in, Ka_in, Mn_in, nloops_in, weylordering_in) {};
