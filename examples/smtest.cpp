...
int main(int, char**){
  ...
  std::complex<double> La_MZ(125.09/174.104,0.);   // quartic Higgs coupling
  ...
  sm values(g_MZ,La_MZ,Yu_MZ,Yd_MZ,Ye_MZ);

    std::cout << std::setprecision(5) << std::endl
	      << "SM parameters at " << MZ << " GeV:" << std::endl
	      << "gauge couplings: " << values.g.transpose() << std::endl
	      << "up-type yukawas: " << values.Yu << std::endl
	      << "down-type yukawas: " << values.Yd << std::endl
	      << "charged lepton yukawas: " << values.Ye << std::endl
  ...
  int steps = integrate_adaptive( make_controlled<stepper>( 1E-12 , 1E-12 ) , sm() , values , log(91.) , log(3000.) , 0.01 );
  ...
  std::cout << std::setprecision(5) << std::endl
	    << "SM parameters at 3 TeV:" << std::endl
	    << "gauge couplings: " << values.g.transpose() << std::endl
  ...
  // 10 TeV  
  steps = integrate_adaptive( make_controlled<stepper>( 1E-12 , 1E-12 ) , sm() , values , log(3000.) , log(1.e4) , 0.01 );
  ...
  // write results to standard output
  std::cout << std::setprecision(5) << std::endl
	    << "SM parameters at 10 TeV:" << std::endl
	    << "gauge couplings: " << values.g.transpose() << std::endl
  ...
  // 10^14 GeV
  steps = integrate_adaptive( make_controlled<stepper>( 1E-10 , 1E-10 ) , sm() , values , log(1.e4) , log(1.e14) , 0.01 );
  ...
  // write results to standard output
  std::cout << std::setprecision(5) << std::endl
	    << "SM parameters at 10^14 GeV:" << std::endl
	    << "gauge couplings: " << values.g.transpose() << std::endl
